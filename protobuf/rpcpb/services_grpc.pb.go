...
type SliverRPCClient interface {
	...
	PivotStopListener(ctx context.Context, in *sliverpb.PivotStopListenerReq, opts ...grpc.CallOption) (*sliverpb.PivotListener, error)
...
func (c *sliverRPCClient) PivotStopListener(ctx context.Context, in *sliverpb.PivotStopListenerReq, opts ...grpc.CallOption) (*sliverpb.PivotListener, error) {
	out := new(sliverpb.PivotListener)
...
type SliverRPCServer interface {
	...
	PivotStopListener(context.Context, *sliverpb.PivotStopListenerReq) (*sliverpb.PivotListener, error)
...
func (UnimplementedSliverRPCServer) PivotStopListener(context.Context, *sliverpb.PivotStopListenerReq) (*sliverpb.PivotListener, error) {
