...
var file_rpcpb_services_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0xd9, 0x4e, 0x0a, 0x09, 0x53, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x52, 0x50, 0x43,
	...
	0x01, 0x12, 0x3b, 0x0a, 0x0a, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x12,
	0x17, 0x2e, 0x73, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	0x57, 0x6f, 0x72, 0x6c, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x14, 0x2e, 0x73, 0x6c, 0x69, 0x76, 0x65,
	0x72, 0x70, 0x62, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x42, 0x2c,
...
var file_rpcpb_services_proto_goTypes = []interface{}{
	...
	(*sliverpb.HelloWorldReq)(nil),            // 118: sliverpb.HelloWorldReq
	...
	(*sliverpb.Chmod)(nil),                    // 165: sliverpb.Chmod
	(*sliverpb.Chown)(nil),                    // 166: sliverpb.Chown
	(*sliverpb.Chtimes)(nil),                  // 167: sliverpb.Chtimes
	(*sliverpb.MemfilesAdd)(nil),              // 168: sliverpb.MemfilesAdd
	(*sliverpb.MemfilesRm)(nil),               // 169: sliverpb.MemfilesRm
	(*sliverpb.ProcessDump)(nil),              // 170: sliverpb.ProcessDump
	(*sliverpb.RunAs)(nil),                    // 171: sliverpb.RunAs
	(*sliverpb.Impersonate)(nil),              // 172: sliverpb.Impersonate
	(*sliverpb.RevToSelf)(nil),                // 173: sliverpb.RevToSelf
	(*sliverpb.GetSystem)(nil),                // 174: sliverpb.GetSystem
	(*sliverpb.Task)(nil),                     // 175: sliverpb.Task
	(*sliverpb.ExecuteAssembly)(nil),          // 176: sliverpb.ExecuteAssembly
	(*sliverpb.Migrate)(nil),                  // 177: sliverpb.Migrate
	(*sliverpb.Execute)(nil),                  // 178: sliverpb.Execute
	(*sliverpb.Sideload)(nil),                 // 179: sliverpb.Sideload
	(*sliverpb.SpawnDll)(nil),                 // 180: sliverpb.SpawnDll
	(*sliverpb.Screenshot)(nil),               // 181: sliverpb.Screenshot
	(*sliverpb.CurrentTokenOwner)(nil),        // 182: sliverpb.CurrentTokenOwner
	(*sliverpb.PivotListener)(nil),            // 183: sliverpb.PivotListener
	(*sliverpb.PivotListeners)(nil),           // 184: sliverpb.PivotListeners
	(*clientpb.PivotGraph)(nil),               // 185: clientpb.PivotGraph
	(*sliverpb.ServiceInfo)(nil),              // 186: sliverpb.ServiceInfo
	(*sliverpb.MakeToken)(nil),                // 187: sliverpb.MakeToken
	(*sliverpb.EnvInfo)(nil),                  // 188: sliverpb.EnvInfo
	(*sliverpb.SetEnv)(nil),                   // 189: sliverpb.SetEnv
	(*sliverpb.UnsetEnv)(nil),                 // 190: sliverpb.UnsetEnv
	(*clientpb.Backdoor)(nil),                 // 191: clientpb.Backdoor
	(*sliverpb.RegistryRead)(nil),             // 192: sliverpb.RegistryRead
	(*sliverpb.RegistryWrite)(nil),            // 193: sliverpb.RegistryWrite
	(*sliverpb.RegistryCreateKey)(nil),        // 194: sliverpb.RegistryCreateKey
	(*sliverpb.RegistryDeleteKey)(nil),        // 195: sliverpb.RegistryDeleteKey
	(*sliverpb.RegistrySubKeyList)(nil),       // 196: sliverpb.RegistrySubKeyList
	(*sliverpb.RegistryValuesList)(nil),       // 197: sliverpb.RegistryValuesList
	(*sliverpb.SSHCommand)(nil),               // 198: sliverpb.SSHCommand
	(*clientpb.DllHijack)(nil),                // 199: clientpb.DllHijack
	(*sliverpb.GetPrivs)(nil),                 // 200: sliverpb.GetPrivs
	(*sliverpb.RportFwdListener)(nil),         // 201: sliverpb.RportFwdListener
	(*sliverpb.RportFwdListeners)(nil),        // 202: sliverpb.RportFwdListeners
	(*sliverpb.RegisterExtension)(nil),        // 203: sliverpb.RegisterExtension
	(*sliverpb.CallExtension)(nil),            // 204: sliverpb.CallExtension
	(*sliverpb.ListExtensions)(nil),           // 205: sliverpb.ListExtensions
	(*sliverpb.RegisterWasmExtension)(nil),    // 206: sliverpb.RegisterWasmExtension
	(*sliverpb.ListWasmExtensions)(nil),       // 207: sliverpb.ListWasmExtensions
	(*sliverpb.ExecWasmExtension)(nil),        // 208: sliverpb.ExecWasmExtension
	(*sliverpb.WGPortForward)(nil),            // 209: sliverpb.WGPortForward
	(*sliverpb.WGSocks)(nil),                  // 210: sliverpb.WGSocks
	(*sliverpb.WGTCPForwarders)(nil),          // 211: sliverpb.WGTCPForwarders
	(*sliverpb.WGSocksServers)(nil),           // 212: sliverpb.WGSocksServers
	(*sliverpb.Shell)(nil),                    // 213: sliverpb.Shell
	(*sliverpb.Portfwd)(nil),                  // 214: sliverpb.Portfwd
	(*sliverpb.HelloWorld)(nil),               // 215: sliverpb.HelloWorld
}
var file_rpcpb_services_proto_depIdxs = []int32{
	...
	118, // 166: rpcpb.SliverRPC.HelloWorld:input_type -> sliverpb.HelloWorldReq
	...
	165, // 264: rpcpb.SliverRPC.Chmod:output_type -> sliverpb.Chmod
	166, // 265: rpcpb.SliverRPC.Chown:output_type -> sliverpb.Chown
	167, // 266: rpcpb.SliverRPC.Chtimes:output_type -> sliverpb.Chtimes
	157, // 267: rpcpb.SliverRPC.MemfilesList:output_type -> sliverpb.Ls
	168, // 268: rpcpb.SliverRPC.MemfilesAdd:output_type -> sliverpb.MemfilesAdd
	169, // 269: rpcpb.SliverRPC.MemfilesRm:output_type -> sliverpb.MemfilesRm
	170, // 270: rpcpb.SliverRPC.ProcessDump:output_type -> sliverpb.ProcessDump
	171, // 271: rpcpb.SliverRPC.RunAs:output_type -> sliverpb.RunAs
	172, // 272: rpcpb.SliverRPC.Impersonate:output_type -> sliverpb.Impersonate
	173, // 273: rpcpb.SliverRPC.RevToSelf:output_type -> sliverpb.RevToSelf
	174, // 274: rpcpb.SliverRPC.GetSystem:output_type -> sliverpb.GetSystem
	175, // 275: rpcpb.SliverRPC.Task:output_type -> sliverpb.Task
	175, // 276: rpcpb.SliverRPC.Msf:output_type -> sliverpb.Task
	175, // 277: rpcpb.SliverRPC.MsfRemote:output_type -> sliverpb.Task
	176, // 278: rpcpb.SliverRPC.ExecuteAssembly:output_type -> sliverpb.ExecuteAssembly
	177, // 279: rpcpb.SliverRPC.Migrate:output_type -> sliverpb.Migrate
	178, // 280: rpcpb.SliverRPC.Execute:output_type -> sliverpb.Execute
	178, // 281: rpcpb.SliverRPC.ExecuteWindows:output_type -> sliverpb.Execute
	179, // 282: rpcpb.SliverRPC.Sideload:output_type -> sliverpb.Sideload
	180, // 283: rpcpb.SliverRPC.SpawnDll:output_type -> sliverpb.SpawnDll
	181, // 284: rpcpb.SliverRPC.Screenshot:output_type -> sliverpb.Screenshot
	182, // 285: rpcpb.SliverRPC.CurrentTokenOwner:output_type -> sliverpb.CurrentTokenOwner
	183, // 286: rpcpb.SliverRPC.PivotStartListener:output_type -> sliverpb.PivotListener
	0,   // 287: rpcpb.SliverRPC.PivotStopListener:output_type -> commonpb.Empty
	184, // 288: rpcpb.SliverRPC.PivotSessionListeners:output_type -> sliverpb.PivotListeners
	185, // 289: rpcpb.SliverRPC.PivotGraph:output_type -> clientpb.PivotGraph
	186, // 290: rpcpb.SliverRPC.StartService:output_type -> sliverpb.ServiceInfo
	186, // 291: rpcpb.SliverRPC.StopService:output_type -> sliverpb.ServiceInfo
	186, // 292: rpcpb.SliverRPC.RemoveService:output_type -> sliverpb.ServiceInfo
	187, // 293: rpcpb.SliverRPC.MakeToken:output_type -> sliverpb.MakeToken
	188, // 294: rpcpb.SliverRPC.GetEnv:output_type -> sliverpb.EnvInfo
	189, // 295: rpcpb.SliverRPC.SetEnv:output_type -> sliverpb.SetEnv
	190, // 296: rpcpb.SliverRPC.UnsetEnv:output_type -> sliverpb.UnsetEnv
	191, // 297: rpcpb.SliverRPC.Backdoor:output_type -> clientpb.Backdoor
	192, // 298: rpcpb.SliverRPC.RegistryRead:output_type -> sliverpb.RegistryRead
	193, // 299: rpcpb.SliverRPC.RegistryWrite:output_type -> sliverpb.RegistryWrite
	194, // 300: rpcpb.SliverRPC.RegistryCreateKey:output_type -> sliverpb.RegistryCreateKey
	195, // 301: rpcpb.SliverRPC.RegistryDeleteKey:output_type -> sliverpb.RegistryDeleteKey
	196, // 302: rpcpb.SliverRPC.RegistryListSubKeys:output_type -> sliverpb.RegistrySubKeyList
	197, // 303: rpcpb.SliverRPC.RegistryListValues:output_type -> sliverpb.RegistryValuesList
	198, // 304: rpcpb.SliverRPC.RunSSHCommand:output_type -> sliverpb.SSHCommand
	199, // 305: rpcpb.SliverRPC.HijackDLL:output_type -> clientpb.DllHijack
	200, // 306: rpcpb.SliverRPC.GetPrivs:output_type -> sliverpb.GetPrivs
	201, // 307: rpcpb.SliverRPC.StartRportFwdListener:output_type -> sliverpb.RportFwdListener
	202, // 308: rpcpb.SliverRPC.GetRportFwdListeners:output_type -> sliverpb.RportFwdListeners
	201, // 309: rpcpb.SliverRPC.StopRportFwdListener:output_type -> sliverpb.RportFwdListener
	98,  // 310: rpcpb.SliverRPC.OpenSession:output_type -> sliverpb.OpenSession
	0,   // 311: rpcpb.SliverRPC.CloseSession:output_type -> commonpb.Empty
	203, // 312: rpcpb.SliverRPC.RegisterExtension:output_type -> sliverpb.RegisterExtension
	204, // 313: rpcpb.SliverRPC.CallExtension:output_type -> sliverpb.CallExtension
	205, // 314: rpcpb.SliverRPC.ListExtensions:output_type -> sliverpb.ListExtensions
	206, // 315: rpcpb.SliverRPC.RegisterWasmExtension:output_type -> sliverpb.RegisterWasmExtension
	207, // 316: rpcpb.SliverRPC.ListWasmExtensions:output_type -> sliverpb.ListWasmExtensions
	208, // 317: rpcpb.SliverRPC.ExecWasmExtension:output_type -> sliverpb.ExecWasmExtension
	209, // 318: rpcpb.SliverRPC.WGStartPortForward:output_type -> sliverpb.WGPortForward
	209, // 319: rpcpb.SliverRPC.WGStopPortForward:output_type -> sliverpb.WGPortForward
	210, // 320: rpcpb.SliverRPC.WGStartSocks:output_type -> sliverpb.WGSocks
	210, // 321: rpcpb.SliverRPC.WGStopSocks:output_type -> sliverpb.WGSocks
	211, // 322: rpcpb.SliverRPC.WGListForwarders:output_type -> sliverpb.WGTCPForwarders
	212, // 323: rpcpb.SliverRPC.WGListSocksServers:output_type -> sliverpb.WGSocksServers
	213, // 324: rpcpb.SliverRPC.Shell:output_type -> sliverpb.Shell
	214, // 325: rpcpb.SliverRPC.Portfwd:output_type -> sliverpb.Portfwd
	114, // 326: rpcpb.SliverRPC.CreateSocks:output_type -> sliverpb.Socks
	0,   // 327: rpcpb.SliverRPC.CloseSocks:output_type -> commonpb.Empty
	115, // 328: rpcpb.SliverRPC.SocksProxy:output_type -> sliverpb.SocksData
	116, // 329: rpcpb.SliverRPC.CreateTunnel:output_type -> sliverpb.Tunnel
	0,   // 330: rpcpb.SliverRPC.CloseTunnel:output_type -> commonpb.Empty
	117, // 331: rpcpb.SliverRPC.TunnelData:output_type -> sliverpb.TunnelData
	23,  // 332: rpcpb.SliverRPC.Events:output_type -> clientpb.Event
	215, // 333: rpcpb.SliverRPC.HelloWorld:output_type -> sliverpb.HelloWorld
